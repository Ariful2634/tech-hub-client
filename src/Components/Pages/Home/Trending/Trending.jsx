...
const Trending = ({product,refetch}) => {
    ...
    const {_id, product_image, product_name, timestamp, upvoted,voteEmail,tags} = product
        ...
        <div>
            <div className="card w-96 h-[460px] p-4 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <p className="space-x-3"><span className="font-bold text-blue-600">Tags:</span> #{tags} </p>
